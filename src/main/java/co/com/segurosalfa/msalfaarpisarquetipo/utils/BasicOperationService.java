...
public abstract class BasicOperationService<R, P> {
	...
	public BasicOperationService(Map<String, String> headers, R response, P request) {
		this.headers = headers;
		this.request = request;
		this.response = response;
	}
	
	public BasicOperationService(Map<String, String> headers, R response) {
		this.headers = headers;
		this.response = response;
	}
	...
	public R run() throws ComponentException {
		...
		try {
			...
			error = new ComponentException("", CodeTypeError.ERROR_INESPERADO, e.getCause().getMessage(), "",location);
	...
	public BasicOperationService<R, P> setCommonInfo(String serviceClass, String serviceMethod) {
		this.serviceClass = serviceClass;
		this.serviceMethod = serviceMethod;
		return this;
	}

	public BasicOperationService<R, P> initializer() {
